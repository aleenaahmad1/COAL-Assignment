...
//asrlannnnnn awalaalalal kaaaaaam
var processorHighlight =false;
var div=document.createElement('button');
var divv=document.createElement('div');
var dialoguebox=document.createElement('input')
dialoguebox.style.fontSize='25px'
// dialoguebox.style.height='65px'
dialoguebox.id='dialogues';
...
document.getElementById('ara').onclick=function (){
    ...
    // movmemtoreg("AX","000F");
    parsing("xor CX,DX");
    // if(document.getElementById('processor').style.webkitAnimationPlayState="running"){
    if(processorHighlight==true){
    document.getElementBy
        Id('processor').classList.remove('anime');
    }
    // }
    heelo();
    ...
    document.getElementById('skrt').onclick=function (){
        ...
        // console.log(document.getElementById('skrt').id);

        document.getElementById('ara').style.visibility='visible';
        document.getElementById('processor').classList.add('anime');
        processorHighlight=true;
        console.log( document.getElementById('processor').classList)
        dialoguebox.value='';
        // document.getElementById('00').innerHTML='Qudsia';
        // window.alert('ghalat')
        // parsing(document.getElementById())
        console.log(dialoguebox.id);
        // // document.getElementById('baki1'
        // ).style.animation='example';
        // // document.getElementById('baki1').style.animationIterationCount='infinite';
        // // document.getElementById('baki1').style.animationDuration='3s';
        // if(!processorHighlight){document.getElementById('processor').style.webkitAnimationPlayState="running";
        // processorHighlight=true;}
...
//     clicked=false;
// }
// document.getElementById('01').innerHTML='maliha';
...
// ]);
//
// let labels = new Map([["AX", "AX"],["BX","Bx"],["CX","Cx"],["DX","Dx"],["DS","Ds"],["IR","IR"],["PC","PC"],["0000","0000"],
//         ['0001', "0001"], ['0002', "0002"], ['0003', "0003"], ['0004', "0004"], ['0005', "0005"], ['0006', "0006"],
//         ['0007', "0007"], ['0008', "0008"], ['0009', "0009"], ['000A', "000A"], ['000B', "000B"], ['000C', "000C"],
//         ['000D', "000D"], ['000E', "000E"],['000F', "000F"]]
//     );
//
// //mov reg to imm
...
//         // document.getElementById('Ax').innerHTML=val2;
//         }
//     }],
...
//         regVal.set(regkey+"L",val2.slice(2,4));
//         regVal.set(regkey+"H",val2.slice(0,2));
//         document.getElementById(dest).innerHTML=val2;
//         //setreg(destname,val2);
//     }],
...
//         console.log(val2)
//         regkey = dest.slice(0,1);
//         you_decide = regkey.slice(-1);//changed from dest to regkey
//         if(you_decide=="H"||you_decide=="L")
//         {
//             setsize("00",val2);
//             if(you_decide=="H")
...
//     const splitArray = input.split(" "); //splitArray[1] dest, [1234H], cx,
//     splitArray[1]=splitArray[1].substring(0,2);
...
function movregtoimm(reg,value){
    ...
    regVal.set(regkey+"L",value.slice(2,4));
    regVal.set(regkey+"H",value.slice(0,2));
    //setreg(destname,value);//checek krna hai iski value ko
    document.getElementById(regkey+'X').innerHTML=value;
}
...
let instruction = new Map([
    ["MOV", function(dest,source){
        if (is_immediate(source))
        {
            ...
            console.log("slay: ",source);//removing square brackets
